#!/bin/bash
#./experiments/scripts/test_GRP_HAI.sh 0 pascal_voc_0712 1 0 0
set -x
set -e
...
WEIGHTS_PATH=/media/data/GRP-HAI/experiments/change_det/pascal_voc_0712/P4/res101/change_det-1/output/P4/res101/voc_2007_trainval+voc_2012_trainval/res101_GRP_HAI_iter_110000.ckpt
