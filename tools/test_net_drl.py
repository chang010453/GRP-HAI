...
def parse_args():
  ...
  """
    ...
    parser.add_argument('--model', dest='model',
                        help='model to test',
                        default='/media/data/GRP-HAI/experiment/drl-model-1/pascal_voc_0712/P4/res101/reg-1/output/res101_GRP_HAI/voc_2007_trainval+voc_2012_trainval/res101_GRP_HAI_iter_110000.ckpt',
                        type=str)
