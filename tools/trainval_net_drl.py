...
# Written by Hsiao-Chien Chang, NSYSU
...
def parse_args():
  ...
  """
    ...
    parser = argparse.ArgumentParser(description='Train a GRP-HAI network')
    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file',
                        default='experiments/cfgs/GRP-HAI-P4.yml', type=str)
    parser.add_argument('--weight', dest='weight',
                        help='initialize with pretrained model weights',
                        default='/media/data/GRP-HAI/fr-rcnn-weights/P4/res101/voc_2007_trainval+voc_2012_trainval/default/res101_faster_rcnn_iter_180000.ckpt',
                        type=str)
    # default = '/media/data/GRP-HAI/fr-rcnn-voc2007-2012-trainval/vgg16_faster_rcnn_iter_180000.ckpt'

    parser.add_argument('--save', dest='save_path',
                        help='path for saving model weights',
                        default='/media/data/GRP-HAI/experiments/test/pascal_voc_0712/P4/res101/test-1/', type=str)
...
if __name__ == '__main__':
    ...
    cfg_from_list(['GRP_HAI_TRAIN.DET_START', args.det_start])

    # output directory where the models are saved
    output_dir = get_output_dir(imdb, args.tag, args.save_path)

    logger = setup_logger("GRP-HAI", save_dir=args.save_path, filename="log_train.txt")
    logger.info('Called with args:')
    logger.info(args)
    logger.info('Using attention alpha:')
    logger.info(cfg.GRP_HAI.ALPHA)
