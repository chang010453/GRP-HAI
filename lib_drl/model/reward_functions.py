# --------------------------------------------------------
# Fixate and Done action reward computations for GRP-HAI
...
def reward_fixate(pred_bboxes, gt_bboxes, gt_max_ious):
    ...
    # bbox_max_ious：(nbr_bboxes, nbr_gt_bboxes)
    ...
    # iou_thresh = 0.5
    iou_thresh = cfg.GRP_HAI_TRAIN.IOU_THRESH
    ...
    # inst_wise_max_bbox_max_ious = IoU_i_t
    ...
    # sum(
    reward_fixate = np.sum((inst_wise_max_bbox_max_ious[idxs_new_better_than_prev]
